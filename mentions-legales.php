...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <title>
      Mentions légales | Allo Taxi Sud Saint-Étienne-du-Grès - Votre taxi 7 jours/7 à Saint-Étienne-du-Grès et ses alentours
    </title>
    ...
    <link
      rel="canonical"
      href="https://allo-taxi-st-etienne-du-gres.fr/mentions-legales.php" />
 

    <!-- Open Graph (Facebook & LinkedIn) -->
    <meta
      property="og:title"
      content="Politique de confidentialité - Allo Taxi Sud Saint-Étienne-du-Grès" />
    <meta
    ...
    <meta
      property="og:url"
      content="https://allo-taxi-st-etienne-du-gres.fr/mentions-legales.php" />
    ...
    <main role="main">
      ...
      <section class="card">
        ...
        <p>
          ...
          du site allo-taxi-st-etienne-du-gres.fr l’identité des différents
          intervenants dans le cadre de sa réalisation et de son suivi :
          <br /><br />
          <strong> Propriétaire : </strong> Louis Chabran Taxi– 16 che Fourques
          13990 Saint-Étienne-du-Grès <br /><br />
      ...
      <section class="card">
        ...
        <p>
          L’utilisation du site allo-taxi-st-etienne-du-gres.fr implique
          ...
          allo-taxi-st-etienne-du-gres.fr sont donc invités à les consulter de
          manière régulière.
          <br /><br />
          ...
          <br /><br />
          Le site allo-taxi-st-etienne-du-gres.fr est mis à jour régulièrement par la
      ...
      <section class="card">
        ...
        <p>
          Le site Allo Taxi Sud Saint-Étienne-du-Grès a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
          <br /><br />
          Allo Taxi Sud Saint-Étienne-du-Grès s’efforce de fournir sur le site
          allo-taxi-st-etienne-du-gres.fr des informations aussi précises que
          ...
          informations.
          <br /><br />
          Tous les informations indiquées sur le site Allo Taxi Sud Saint-Étienne-du-Grès sont données
          à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site Allo Taxi Sud Saint-Étienne-du-Grès ne sont pas
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Saint-Étienne-du-Grès est propriétaire des droits de propriété intellectuelle
          ...
          préalable de : Allo Taxi Sud Saint-Étienne-du-Grès.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Saint-Étienne-du-Grès ne pourra être tenu responsable des dommages directs et
          indirects causés au matériel de l’utilisateur, lors de l’accès au site
          Allo Taxi Sud Saint-Étienne-du-Grès, et résultant soit de l’utilisation d’un matériel ne
          répondant pas aux spécifications indiquées au point 4, soit de
          l’apparition d’un bug ou d’une incompatibilité.
          <br /><br />
          Allo Taxi Sud Saint-Étienne-du-Grès ne pourra également être tenue responsable des dommages
          indirects (tels par exemple qu’une perte de marché ou perte d’une
          chance) consécutifs à l’utilisation du site
          allo-taxi-st-etienne-du-gres.fr.
          <br /><br />
          ...
          relatives à la protection des données. Le cas échéant, Allo Taxi Sud Saint-Étienne-du-Grès
      ...
      <section class="card">
        ...
        <p>
          ...
          octobre 1995.
          <br /><br />
          A l’occasion de l’utilisation du site allo-taxi-st-etienne-du-gres.fr,
          peuvent êtres recueillies : l’URL des liens par l’intermédiaire
          desquels l’utilisateur a accédé au site allo-taxi-st-etienne-du-gres.fr, le
          ...
          services proposés par le site allo-taxi-st-etienne-du-gres.fr (prise de
          ...
          l’utilisateur du site allo-taxi-st-etienne-du-gres.fr l’obligation ou non
          ...
          allo-taxi-st-etienne-du-gres.fr n’est publiée à l’insu de l’utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l’hypothèse du rachat de Allo Taxi Sud Saint-Étienne-du-Grès et de ses droits
          ...
          du site allo-taxi-st-etienne-du-gres.fr.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          Le site allo-taxi-st-etienne-du-gres.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Allo Taxi Sud Saint-Étienne-du-Grès. Cependant, Allo Taxi Sud Saint-Étienne-du-Grès n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n’assumera en
          conséquence aucune responsabilité de ce fait.
          <br /><br />
          La navigation sur le site allo-taxi-st-etienne-du-gres.fr est susceptible
      ...
      <section class="card">
        ...
        <p>
          ...
          allo-taxi-st-etienne-du-gres.fr est soumis au droit français.
        </p>
      </section>
